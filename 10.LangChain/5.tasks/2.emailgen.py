...
chat_prompt = ChatPromptTemplate.from_messages([
    ...
    HumanMessagePromptTemplate.from_template(
        "수신자 {recipient}에게 다음 주제 {topic} 에 대한 미팅 요청을 하는 메일을 작성해주시오.\n\n"
    )
])
...
topics = ["신제품 출시 전략", "분기별 개발 성과 지표", "개인별 매출 목표치 달성 현황 리뷰", "개발을 잘 못해서 맨날 버그만 발생시키는 개발자 해고"]
