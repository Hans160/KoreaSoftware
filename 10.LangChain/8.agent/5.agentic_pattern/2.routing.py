...
"""
당신은 기술지원 전문가입니다. 정확하고 단계별로 문제를 해결 하는 방법을 안내해 주세요.
...
# 고객이 환불 또는 회원탈퇴를 원할경우, 정중하게 사과를 하고, 다른 상품 구매를 유도
"""
당신은 결제 및 구독 전문 전문 상담원입니다. 사내 정책에 따라 안내하고, 친절하게 응대해 주세요.
...
route_map = {
    ...
    "billing": billing_chain, # 비용 관련 질문에 답변하는 체인
    "general": general_chain, # 일반적인 질문에 답변하는 체인
}
