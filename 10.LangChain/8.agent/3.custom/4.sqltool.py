...
"""
CREATE TABLE users (
    id INTEGER PRIMARY KEY, name TEXT, city TEXT, age INTEGER);
...
(3, '박영희', '서울', 28), (4, '최민수', '인천', 35);
                   
INSERT INTO products (id, name, price, category) VALUES
(1, "노트북", 1500000, "전자"), (2, "마우스", 30000, "전자"),
(3, "책상", 200000, "가구"), (4, "의자", 100000, "가구");
...
(5, 2, 3, 1, "2026-05-05"), (6, 2, 4, 4, "2026-05-06");                                  
"""
)
...
def run_sql(query:str) -> str:
    """ SQLite_DB 에 SQL 구문을 실행하고 결과를 반환한다."""
    ...
    # 위에 쿼리 결과를 최대한 이쁘게 자연어로 변환하는 코드
    out = [" | ".join(cols)]
...
- SQLite3 문법만을 사용하고 JOIN, GROUP BY, ORDER BY 등도 사용 가능 함.
"""
...
for q in questions:
    ...
    print(f"최종답변: {result['messages'][-1].content}")